...
export const canonicalRoutes: SiteRoute[] = [
  ...
  },
  {
    ...
    category: "public",
    description: "API keys, usage metrics, and developer tools",
    isPublic: true,
    isCanonical: true,
    menuGroup: "resources",
    owner: "engineering",
  ...
  },
  {
    ...
    label: "Documentation",
    category: "public",
    description: "API documentation, guides, and SDK references",
    isPublic: true,
    isCanonical: true,
    menuGroup: "resources",
    owner: "engineering",
  ...
  },
  {
    ...
    label: "My Portfolio",
    category: "protected",
    description: "Personal investment summary and holdings overview",
    isPublic: false,
    isCanonical: true,
    menuGroup: "none",
    owner: "platform",
  ...
  {
    path: "/app/savings-vault",
    label: "Savings Vault",
    category: "protected",
    description: "Secure savings vaults with competitive yields",
    isPublic: false,
    isCanonical: true,
    menuGroup: "none",
    owner: "financial",
