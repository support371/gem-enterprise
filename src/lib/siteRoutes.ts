...
export const canonicalRoutes: SiteRoute[] = [
  ...
  // AUTH
  {
    ...
    category: "auth",
    description: "Role-aware directory for every approved GEM account",
    isPublic: true,
    isCanonical: true,
    menuGroup: "utility",
    owner: "auth",
  ...
  },
  {
    ...
    label: "Team Login",
    category: "auth",
    description: "Assigned team and project workspace sign-in portal",
    isPublic: true,
    isCanonical: true,
    menuGroup: "utility",
    owner: "auth",
  ...
  },
  {
    ...
    label: "Admin Login",
    category: "auth",
    description: "Scoped GEM Enterprise administration sign-in portal",
    isPublic: true,
    isCanonical: true,
    menuGroup: "utility",
    owner: "auth",
  ...
  },
  {
    ...
    category: "auth",
    description: "Restricted GEM platform-owner control-plane sign-in portal",
    isPublic: true,
    isCanonical: true,
    menuGroup: "utility",
    owner: "auth",
  ...
  {
    path: "/app/workspace",
    label: "GEM Enterprise Workspace OS",
    category: "protected",
    description: "Membership-scoped organization and project operating system",
    isPublic: false,
    isCanonical: true,
    menuGroup: "none",
    owner: "workspace",
  ...
  {
    path: "/app/ai-services",
    label: "GEM AI Services",
    category: "protected",
    description: "Governed assistance, intelligence, agents, automation, and AI-media directory",
    isPublic: false,
    isCanonical: true,
    menuGroup: "none",
    owner: "workspace",
  ...
  },
  {
    ...
    category: "protected",
    description: "Membership-protected governed connector and activation directory",
    isPublic: false,
    isCanonical: true,
    menuGroup: "none",
    owner: "workspace",
