...
import { MessageCircle, X, Send, Bot, User, Loader2, Zap, Shield, AlertTriangle, Phone } from "lucide-react";
...
export const GemAssist = () => {
  ...
  return (
    <>
      {/* Floating Button — plain button, CSS hover/active via Tailwind */}
      {!isOpen && (
        <button
      ...
      {/* Chat Panel — CSS animate-scale-in on open, conditional render on close */}
      {isOpen && (
        <div
          className={cn(
        ...
        >
          {/* Header */}
          <div className="flex items-center justify-between p-4 border-b border-border bg-card/80 shrink-0">
