...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Docs Hub", description: "Platform operating manual and access model", href: "/docs" },
      { title: "API Dashboard", description: "API operations, endpoints, telemetry, and governance", href: "/api-dashboard" },
      { title: "Developer Dashboard", description: "API keys, usage metrics, and integration tools", href: "/developers" },
