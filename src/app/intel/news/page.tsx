...
// The GEM Intel feed is currently served from a companion Base44-hosted surface.
// We frame it inside a GEM enterprise shell so the experience stays branded.
// When the native /intel/news CMS ships, swap GEM_INTEL_FEED_URL for the local
// route without changing the page URL or navigation.
    ...
    <main className="min-h-screen bg-background text-foreground">
            ...
            <div className="max-w-2xl">
              <div className="flex items-center gap-2 mb-4">
                <Badge className="bg-primary/10 text-primary border-primary/30 font-mono text-xs tracking-widest">
                  <Rss className="h-3 w-3 mr-1.5" /> GEM INTEL · LIVE FEED
                </Badge>
              ...
              <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-balance">
                GEM Intel <span className="text-gradient-primary">News Feed</span>
              </h1>
              <p className="text-lg text-muted-foreground leading-relaxed text-pretty">
                Continuous intelligence across crypto, cybersecurity, markets,
                geopolitics, policy, and alternatives — curated by the GEM analyst
                team and delivered straight into the enterprise workspace.
              </p>
            </div>
      ...
      <section className="bg-card/20">
        <div
          className={`transition-all duration-500 ${
            expanded ? "fixed inset-0 z-50 bg-background" : "container mx-auto px-6 py-8 max-w-6xl"
          }`}
        >
          {/* Frame chrome */}
          <div
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-foreground">
                GEM Intel — {CATEGORY_QUICK_LINKS.find((c) => c.slug === activeCategory)?.label}
              </span>
          ...
          <div
            className={`rounded-xl overflow-hidden border border-border/50 bg-black ${
              expanded ? "h-[calc(100vh-80px)] mx-4 mb-4" : "h-[700px] md:h-[820px]"
            }`}
          >
            <iframe
              key={iframeKey}
      ...
      <section className="border-t border-border py-16 container mx-auto px-6 max-w-6xl">
        <div className="grid md:grid-cols-3 gap-4">
          <Card className="glass-panel bento-card border-border/50">
            <CardContent className="p-6">
              ...
              <h3 className="font-semibold text-foreground mb-2">Analyst-curated</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Every headline in this feed is filtered, scored, and tagged by the
                GEM research team before it reaches members.
              </p>
            </CardContent>
          </Card>
          <Card className="glass-panel bento-card border-border/50">
            <CardContent className="p-6">
              ...
              <h3 className="font-semibold text-foreground mb-2">Push to Newsletters</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                The most signal-dense stories are republished into the GEM Threat
                Wire and Financial Security Monitor each cycle.
              </p>
            </CardContent>
          </Card>
          <Card className="glass-panel bento-card border-border/50">
            <CardContent className="p-6">
              ...
              <h3 className="font-semibold text-foreground mb-2">Member Briefings</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
                Community Hub members receive private commentary and context on
                high-impact stories through the{" "}
                <Link href="/community-hub/knowledge" className="text-primary hover:underline">
                  Knowledge
                </Link>{" "}
                channel.
              </p>
        ...
        <div className="mt-10 text-center text-xs text-muted-foreground">
          Want this feed embedded directly in your operations workspace?{" "}
