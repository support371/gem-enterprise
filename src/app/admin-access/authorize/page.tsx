    ...
    <main className="min-h-screen bg-[#07101f] px-4 py-12 text-white">
      <section className="mx-auto w-full max-w-3xl rounded-2xl border border-cyan-500/20 bg-white/[0.04] p-6 shadow-2xl sm:p-8">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm leading-6 text-slate-400">
              This browser generates the one-time capability locally. Only its
              SHA-256 hash appears in the SQL statement. The usable capability
              remains in this browser session and is never sent through chat,
        ...
        {!authorization ? (
          ...
          <div className="mt-8 space-y-6">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-green-100/70">
                    It expires at {expiryLabel}. Keep this browser tab open while
                    completing the SQL step.
                  </p>
                </div>
              </div>
            </section>
              ...
              <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-slate-400">
                    The statement contains the token hash, not the usable token.
                  </p>
                </div>
                <Button
                  type="button"
            ...
            <section className="rounded-xl border border-white/10 bg-white/[0.02] p-5">
              <h2 className="font-semibold">2. Run it in Supabase</h2>
              <p className="mt-2 text-sm leading-6 text-slate-400">
                Open the official SQL Editor in a new tab, paste the copied
                statement, and press <strong className="text-white">Run</strong>.
                A successful result returns one row with an ID and expiry time.
              </p>
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-amber-500/20 bg-amber-500/[0.06] p-4 text-sm text-amber-100/80">
              ...
              />
              <span>
                I ran the statement in the Supabase project and it returned one
                authorization row.
              </span>
            </label>
        ...
        <p className="mt-6 text-center text-xs leading-5 text-slate-500">
          No password is created on this page. After authorization, you choose
          the password on the next screen.{" ""}
